export default function Loading() {
  return (
    <div className="bg-black h-screen md:h-[var(--home-height)] flex flex-col justify-center items-center">
      <svg
      ...
      >
        <defs>
          <clipPath id="ldio-idnpo7jggcl-cp">
        ...
        <g id="ldio-idnpo7jggcl-rainbow" clipPath="url(#ldio-idnpo7jggcl-cp)">
          <path
            fill="#ff9922"
            strokeWidth="0"
